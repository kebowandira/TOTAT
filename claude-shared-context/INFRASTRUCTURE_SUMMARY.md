...
- ⏳ **GreenCloud:** SSH access confirmed (root, key-only), but **no hardening done yet** — still fresh/unhardened as of the handoff. Next session should treat it like Step 2 (adapted per Step 5's own note: no web ports needed, just SSH+basic services).
